...
GoldenrodArchives1BF_MapEvents:
	...
	warp_event 13,  1, GOLDENROD_ARCHIVES_2BF, 1
	...
	object_event  4,  9, SPRITE_GHOST_COOLTRAINER_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerCooltrainermErickGhostGhost, EVENT_GOT_ITEMFINDER
