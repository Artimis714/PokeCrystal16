...
; Kanto hidden items
	...
	const EVENT_BABYBRORESTS
	const EVENT_SPOKE_TO_DALES_DAD
	const EVENT_GOT_PROTOTYPE_UPGRADE
	const EVENT_GOT_OLD_AMBER_CIANWOOD
	const EVENT_GOT_LUCKY_EGG_ECRUTEAK
	const EVENT_GOT_LIGHT_BALL_VIOLET_CITY
	const EVENT_GOT_BRIGHTPOWDER
	const EVENT_GHOST_GRUNTM12
	const EVENT_GHOST_DALE
	const EVENT_GHOST_GREGG
	const EVENT_BURNEDTOWER_GHOST2
	const EVENT_BURNEDTOWER_GHOST1
	const EVENT_GHOST_TYLER
	const EVENT_GHOST_ANDY
	const EVENT_GHOST_ERICK
