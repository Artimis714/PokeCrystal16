...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_GHOST_KIMONO
	const SPRITE_GHOST_GRANNY
	const SPRITE_GHOST_ROCKET
	const SPRITE_GHOST_NERD
	const SPRITE_GHOST_COOLTRAINER_M
	const SPRITE_GHOST_GENTLEMAN
	const SPRITE_GHOST_BEAUTY
	const SPRITE_GHOST_FLOATING
